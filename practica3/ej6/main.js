...
function search() {
    let page = document.getElementById("entry").value;   // por qué no funciona queryselector()?
...
window.addEventListener('load', fetchRickAndMorty(`https://rickandmortyapi.com/api/episode?page=${document.querySelector('select').value}`));
